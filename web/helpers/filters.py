...
# filter for italics, bold, underline, strike and heading
@pass_eval_context
def text_filters(eval_ctx, value):
    ...
    normalized_value = re.sub(r'\[h1\]([\s\S]*?)\[/h1\]', r'<h1 style="margin-bottom: 0;" class="title has-text-black is-3">\1</h1>', normalized_value)
    if eval_ctx.autoescape:
